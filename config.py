...
class Config:
    ...
    # COM configuration
    rxCOM = " "             # Serial port for reciever
    rxBAUD = 19200          # Serial Baudrate for reciever
    txCOM = " "             # Serial port for transmitter
    txBAUD = 19200          # Serial Baudrate for transmitter
    simplexCOM = " "        # Serial port for simplex mode 
                                # (will be used if rxFreq == txFreq)
    simplexBAUD = 19200     # Serial Baudrate for simplex mode
